...
//	private static String chgpassURL = "http://10.0.2.2/learn2crack_login_api/";
	...
	// add new friend
	private static String addNewFriendURL = "http://www.wat-get.tk/addnewfriend.php";
	private static String findAChargerURL = "http://www.wat-get.tk/findcharger.php";
	private static String sendMessageURL = "http://www.wat-get.tk/sendmessage.php";
	private static String getMessageURL = "http://www.wat-get.tk/getmessages.php";
	private static String getPendingNotificationsURL = "http://www.wat-get.tk/getpendingnotifications.php";
...
//		params.add(new BasicNameValuePair("lastname", lname));
	...
	public JSONObject addNewFriend(String sessionid, String friendUserName){
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("sessionid", sessionid));
		params.add(new BasicNameValuePair("friendUserName", friendUserName));
		JSONObject json = jsonParser.getJSONFromUrl(addNewFriendURL, params);
		return json;
	}
	
	public JSONObject findACharger(String sessionid, String deviceid){
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("sessionid", sessionid));
		params.add(new BasicNameValuePair("deviceid", deviceid));
		JSONObject json = jsonParser.getJSONFromUrl(findAChargerURL, params);
		return json;
	}
	
	// sessionid=123456&receiver=abcd&text=foobar
	public JSONObject sendMessage(String sessionid, String receiver, String text){
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("sessionid", sessionid));
	...
	public JSONObject getMessage(String sessionid, String username){// usename is friend_name
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("sessionid", sessionid));
		params.add(new BasicNameValuePair("username", username));
		JSONObject json = jsonParser.getJSONFromUrl(getMessageURL, params);
		return json;
	}
	
	public JSONObject getPendingNotifications(String sessionid){
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("sessionid", sessionid));
		JSONObject json = jsonParser.getJSONFromUrl(getPendingNotificationsURL, params);
		return json;
	}
